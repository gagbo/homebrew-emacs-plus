...
class EmacsPlusAT29lsp < EmacsBase
  init 29
  version "29.0.60-lsp"
  url "https://github.com/emacs-lsp/emacs/tarball/87596d041094e398c4823f1b41a87690478cefca"
  sha256 "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
  env :std

  head do
    url "https://github.com/emacs-lsp/emacs.git", :branch => "json-rpc-29"
  end
  ...
  def caveats
    <<~EOS
      ...
      This is an unofficial fork of d12frosted/homebrew-emacs-plus to support emacs-lsp's fork.
      Report any issues to http://github.com/gagbo/homebrew-emacs-plus
    EOS
  end
